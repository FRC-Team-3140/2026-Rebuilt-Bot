...
public class R2L_Neutral_Shoot extends SequentialCommandGroup {
  private Command pathCommand;

  /** Creates a new R2L_Neutral_Shoot. */
  public R2L_Neutral_Shoot() {
    try {
    ...
    this.addCommands(pathCommand,
        AutoBuilder.pathfindToPose(FlipPose.flipIfRed(Constants.PathplannerConstants.shootPoseL),
